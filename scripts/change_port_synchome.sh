...
SYNC_HOME="$DAEMON_HOME/statesync"
echo "CURRENT_SYNC_HOME :" $SYNC_HOME

# config 경로
CONFIG_FILE="$SYNC_HOME/config/config.toml"
APP_FILE="$SYNC_HOME/config/app.toml"
CLIENT_FILE="$SYNC_HOME/config/client.toml"
...
if [ "$answer" == "y" ] || [ "$answer" == "yes" ]; then
    ...
    cp "${SYNC_HOME}/config/config.toml" "${SYNC_HOME}/config/config.toml.oldport"
    cp "${SYNC_HOME}/config/app.toml" "${SYNC_HOME}/config/app.toml.oldport"
    cp "${SYNC_HOME}/config/client.toml" "${SYNC_HOME}/config/client.toml.oldport"
